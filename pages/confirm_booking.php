...
<body>
    ...
    <?php
        ...
        $hospital_name=$_POST['button_value'];
...
<div class="icons">   
  ...
  <script>
    ...
    /*var originalDate = document.getElementById("myDate").value;
    ...
    <form action="try_backend.php" method="post">
      <h1>Sign Up</h1>
      <label for="name">Name:</label>
      <input type="text" id="name" name="name2" required>
      <label for="name">Hospital:</label>
      <input type="text" name="myTextbox" value="<?php echo $hospital_name; ?>" readonly>
      ...
      <!--type="submit"-->
      <button type="submit" onclick="printfun()">Sign Up</button>
    </form>
